...
st.markdown('<div class="cocktail-left">faust 파우스트 45% </div><div class="cocktail-right">1.7</div>', unsafe_allow_html=True)
st.markdown('<div class="cocktail-left">jungle bird 정글버드 18%<span class = "content"> 정글주스의 맛</span></div>', unsafe_allow_html=True)
