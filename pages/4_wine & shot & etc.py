...
st.markdown('<div class="cocktail-left">SHOT / SHOT*6</div><div class="cocktail-right">0.5 / 2.5</div>', unsafe_allow_html=True)
...
st.title('Beer')
st.markdown('<div class="cocktail-left">Budweiser</div><div class="cocktail-right">0.9</div>', unsafe_allow_html=True)
st.markdown('<div class="cocktail-left">Red Stripe</div><div class="cocktail-right">0.9</div>', unsafe_allow_html=True)
st.markdown('<div class="cocktail-left">Heineken</div><div class="cocktail-right">1.0</div>', unsafe_allow_html=True)
st.markdown('<div class="cocktail-left">Guinness</div><div class="cocktail-right">1.1</div>', unsafe_allow_html=True)
...
st.markdown('<div class="cocktail-left">카베르네 소비뇽</div><div class="cocktail-right">0.8</div>', unsafe_allow_html=True)

st.markdown('<div class = "wine_category"> &nbsp;&nbsp;<i>bottle</i> </div>', unsafe_allow_html = True)
st.markdown('<div class="cocktail-left">2020 프랑스 카베르네-쉬라즈</div><div class="cocktail-right">5.9</div>', unsafe_allow_html=True)
#st.markdown('<div class="cocktail-left">2019 프랑스 피노누아</div><div class="cocktail-right">7.9</div>', unsafe_allow_html=True)
#st.markdown('<div class="cocktail-left">2020 프랑스 피노누아</div><div class="cocktail-right">7.9</div>', unsafe_allow_html=True)

st.markdown('<div class = "category"> WHITE </div>', unsafe_allow_html = True)
st.markdown('<div class = "wine_category"> &nbsp;&nbsp;<i>bottle</i> </div>', unsafe_allow_html = True)
st.markdown('<div class="cocktail-left">2018 프랑스 사르도네</div><div class="cocktail-right">7.9</div>', unsafe_allow_html=True)
