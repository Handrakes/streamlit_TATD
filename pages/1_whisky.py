...
st.markdown('<div class="w-left">Dalwhinnie 15Y 달위니 15Y</div><div class = "w-right"> 1.6 / - </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Dalmore 12Y 달모어 12Y</div><div class = "w-right"> 1.8 / 32.0 </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Dalmore 12Y sherry cask 달모어 12Y 셰리 캐스크</div><div class = "w-right"> 2.0 / - </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Dalmore 15Y 달모어 15Y </div><div class = "w-right"> 2.4 / 41.0 </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Glenmorangie 10Y 글렌모렌지 10Y</div><div class = "w-right"> 1.4 / 23.0 </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Glenmorangie lasanta 12Y 글렌모렌지 라산타 12Y</div><div class = "w-right"> 1.5 / 26.0 </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Glenmorangie necta d''or 글렌모렌지 넥타도르</div><div class = "w-right"> 1.9 / 34.0 </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Glenmorangie 18Y 글렌모렌지 18Y</div><div class = "w-right"> 2.6 / - </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Oban 14Y 오반 14Y</div><div class = "w-right"> 1.8 / 32.0 </div>', unsafe_allow_html = True)


#st.title("Speyside")
st.markdown('<div class = "category"> Speyside </div>', unsafe_allow_html = True)
st.markdown('<div class ="cocktail-right"> G &nbsp; B </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left"> Aberlour A''Bunadh 아벨라워 아부나흐</div><div class = "w-right"> 2.3 / - </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left"> Benromach 10Y 벤로막 10Y</div><div class = "w-right"> 1.4 / - </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left"> Benromach 15Y 벤로막 15Y</div><div class = "w-right"> 2.4 / - </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left"> Glenlivet 12Y 글렌리벳 12Y</div><div class = "w-right"> 1.4 / 23.0 </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left"> Glenlivet 15Y 글렌리벳 15Y</div><div class = "w-right"> 1.7 / 29.0 </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left"> Glenlivet 18Y 글렌리벳 18Y</div><div class = "w-right"> 2.2 / 38.0 </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left"> Glenfiddich 18Y 글렌피딕 18Y</div><div class = "w-right"> 2.3 / 40.0 </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left"> Glenallachie Cuvee cask 글렌알라키 뀌베 캐스크 피니시</div><div class = "w-right"> / - </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left"> Macallan night on earth 맥켈란 나이트 온 어스</div><div class = "w-right"> 2.4 / - </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Bowmore 18Y 보모어 18Y</div><div class="w-right"> 3.5 / - </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Ardbeg 10Y 아드벡 10Y</div><div class="w-right"> 1.6 / 27.0 </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Ardbeg An oa 아드벡 언 오</div><div class="w-right"> 1.8 / 32.0 </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Ardbeg uigeadail 아드벡 우거다일</div><div class="w-right"> 2.1 / 36.0 </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Ardbeg corryvreckan 아드벡 코리브레칸</div><div class="w-right"> 2.5 / 42.0 </div>', unsafe_allow_html=True)
...
st.markdown('<div class="w-left">Lagavulin 16Y 라가불린 16Y</div><div class="w-right"> 2.3 / - </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Kilchoman machir bay 킬호만 마키어 베이</div><div class="w-right"> 1.6 / 27.0 </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Kilchoman sanig 킬호만 사닉</div><div class="w-right"> 1.9 / 34.0 </div>', unsafe_allow_html=True)
st.markdown('<div class="w-left">Kilchoman machir bay CS 킬호만 마키어 베이 CS</div><div class="w-right"> 2.1 / - </div>', unsafe_allow_html=True)
...
st.markdown('<div class="w-left">Arran 10Y 아란 10Y </div><div class = "w-right"> 1.5 / - </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Jack Daniel''s black 잭다니엘 블랙 </div><div class = "w-right"> 1.2 / 11.0</div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Jack Daniel''s Honey 잭다니엘 허니 </div><div class = "w-right"> 1.2 / 11.0</div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Micter''s Small batch 믹터스 스몰 배치</div><div class = "w-right"> 1.7 / 27.0</div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Micter''s Single barrel Rye 믹터스 싱글베럴 라이</div><div class = "w-right"> 1.7/ 27.0</div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Wild Turkey Rarebreed 와일드 터키 레어브리드</div><div class = "w-right"> 1.5 / 25.0</div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Yellow Rose Rye 옐로우 로즈 라이</div><div class = "w-right"> 1.3 / 21.0 </div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">James E.Pepper bourbon 제임스 E.페퍼 버번</div><div class = "w-right"> 1.4 / 23.0</div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">James E.Pepper Rye 제임스 E.페퍼 라이</div><div class = "w-right"> 1.4 / 23.0</div>', unsafe_allow_html = True)
...
st.markdown('<div class="w-left">Blanton''s Single barrel 블랑톤 싱글베럴</div><div class = "w-right"> 3.0 / -</div>', unsafe_allow_html = True)
...
st.markdown('<div class ="cocktail-right"> G &nbsp; B </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Jameson 제임슨 </div><div class = "w-right"> 0.8 / 12.0 </div>', unsafe_allow_html = True)

st.markdown('<div class = "category"> Japanese </div>', unsafe_allow_html = True)
st.markdown('<div class ="cocktail-right"> G &nbsp; B </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Yamazaki 12Y 야마자키 12Y </div><div class = "w-right"> 3.5 / - </div>', unsafe_allow_html = True)

st.markdown('<div class = "category"> Taiwanese </div>', unsafe_allow_html = True)
st.markdown('<div class ="cocktail-right"> G &nbsp; B </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Kavalan Classic 카발란 클래식</div><div class = "w-right"> 2.1 / -</div>', unsafe_allow_html = True)

st.markdown('<div class = "category"> Indian </div>', unsafe_allow_html = True)
st.markdown('<div class ="cocktail-right"> G &nbsp; B </div>', unsafe_allow_html = True)
st.markdown('<div class="w-left">Amrut Fusion 암룻 퓨전</div><div class = "w-right"> 1.7 / 25.0</div>', unsafe_allow_html = True)
